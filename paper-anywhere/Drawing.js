/*jslint browser: true, devel: true, sloppy: true, nomen: true */
/*global SVGMatrix, LineAttribute, Line, User, requestAnimationFrame */
...
Drawing.prototype._redraw = function () {
    var i,
        width = this.viewMetrics.width,
        height = this.viewMetrics.height,
        pixelRatio = this.viewMetrics.pixelRatio,
        that = this;
    if (this.requestAnimationFrameActive) {
        requestAnimationFrame(function () {
            that._redraw();
