/*jslint sloppy: true */
/*global SVGMatrix, LineAttribute, Line, requestAnimationFrame */
function User(obj) {
    ...
    if (obj.view && obj.palette && obj.hasOwnProperty("selectedColorIndex") &&
            obj.hasOwnProperty("strokeWidth") && obj.hasOwnProperty("sliderLock")) {
